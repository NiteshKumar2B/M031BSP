...
void SYS_Init(void)
{
    ...
    CLK_EnableModuleClock(((((2) & 0x03UL) << 30)|((((17)) & 0x1fUL) << 0)| (((2) & 0x03UL) << 28)|(((1) & 0x07UL) << 25)|((((1)) & 0x1fUL) << 20)| (((0x0) & 0x03UL) << 18)|(((0x0) & 0xffUL) << 10)|(((0x0) & 0x1fUL) << 5)));





    CLK_EnablePLL((0x1UL << (19)), 96000000);
...
// CLK_SetModuleClock(((((2) & 0x03UL) << 30)|((((17)) & 0x1fUL) << 0)| (((2) & 0x03UL) << 28)|(((1) & 0x07UL) << 25)|((((1)) & 0x1fUL) << 20)| (((0x0) & 0x03UL) << 18)|(((0x0) & 0xffUL) << 10)|(((0x0) & 0x1fUL) << 5)), CLK_CLKSEL2_PWM1SEL_PCLK0, 0);


    CLK_SetModuleClock(((((2) & 0x03UL) << 30)|((((17)) & 0x1fUL) << 0)| (((2) & 0x03UL) << 28)|(((1) & 0x07UL) << 25)|((((1)) & 0x1fUL) << 20)| (((0x0) & 0x03UL) << 18)|(((0x0) & 0xffUL) << 10)|(((0x0) & 0x1fUL) << 5)), (0x0UL<<(1)), 0);
    ...
    ((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->GPC_MFPL = (((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->GPC_MFPL & (~(0xful << (16)))) |
                    (0x0CUL<<(16));
}
...
void PWM_Init()
{
    ...
    ((((PWM_T *) ((( uint32_t)0x40000000) + 0x59000)))->CLKPSC[(1) >> 1] = (48 - 1));

    ((((PWM_T *) ((( uint32_t)0x40000000) + 0x59000)))->PERIOD[(1>>1)<<1] = (1999));

    ((((PWM_T *) ((( uint32_t)0x40000000) + 0x59000)))->CMPDAT[(1)]= (0));

    do{ int i; for(i = 0; i < 6; i++) { if(((0x00000002UL) ///< Bit 1 mask of an 32 bit integer) & (1 << i)) (((PWM_T *) ((( uint32_t)0x40000000) + 0x59000)))->CTL1 = (((((PWM_T *) ((( uint32_t)0x40000000) + 0x59000)))->CTL1 & ~(3UL << (i << 1))) | (((0UL)) << (i << 1))); } }while(0);

    do{ int i; for(i = 0; i < 6; i++) { if(((0x00000002UL) ///< Bit 1 mask of an 32 bit integer) & (1 << i)) { (((PWM_T *) ((( uint32_t)0x40000000) + 0x59000)))->WGCTL0 = (((((PWM_T *) ((( uint32_t)0x40000000) + 0x59000)))->WGCTL0 & ~(3UL << (i << 1))) | (((1UL)) << (i << 1))); (((PWM_T *) ((( uint32_t)0x40000000) + 0x59000)))->WGCTL0 = (((((PWM_T *) ((( uint32_t)0x40000000) + 0x59000)))->WGCTL0 & ~(3UL << ((16) + (i << 1)))) | (((0UL)) << ((16) + (i << 1)))); (((PWM_T *) ((( uint32_t)0x40000000) + 0x59000)))->WGCTL1 = (((((PWM_T *) ((( uint32_t)0x40000000) + 0x59000)))->WGCTL1 & ~(3UL << (i << 1))) | (((2UL)) << (i << 1))); (((PWM_T *) ((( uint32_t)0x40000000) + 0x59000)))->WGCTL1 = (((((PWM_T *) ((( uint32_t)0x40000000) + 0x59000)))->WGCTL1 & ~(3UL << ((16) + (i << 1)))) | (((0UL)) << ((16) + (i << 1)))); } } }while(0);

    PWM_EnableOutput(((PWM_T *) ((( uint32_t)0x40000000) + 0x59000)), (0x00000002UL) ///< Bit 1 mask of an 32 bit integer);

    PWM_EnablePeriodInt(((PWM_T *) ((( uint32_t)0x40000000) + 0x59000)), 1, 0);
    NVIC_EnableIRQ(PWM1_IRQn);


    PWM_Start(((PWM_T *) ((( uint32_t)0x40000000) + 0x59000)), (0x00000002UL) ///< Bit 1 mask of an 32 bit integer);
}
...
void PWM1_IRQHandler(void)
{
    ...
    ((((PWM_T *) ((( uint32_t)0x40000000) + 0x59000)))->CMPDAT[(1)]= (g_u32BreathingCount));


    PWM_ClearPeriodIntFlag(((PWM_T *) ((( uint32_t)0x40000000) + 0x59000)), 1);
}
