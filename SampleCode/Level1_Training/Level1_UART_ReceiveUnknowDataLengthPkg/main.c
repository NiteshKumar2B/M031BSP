...
void SYS_Init(void)
{
    ...
    SYS_UnlockReg(); // we should unlock corresponding registers to set the clocks
    ...
    SYS_LockReg(); // we should lock the corresponding registers to prevent from revision 
}
